      ...
      <div className="grid gap-6 lg:grid-cols-[420px_1fr]">
        <section className="space-y-3">
          <div className="rounded-lg border border-zinc-200 bg-white p-4">
            ...
            <form className="mt-3 flex flex-wrap items-end gap-2" action="/admin/payroll">
              ...
              <div className="ml-auto">
                {canExport ? (
                  <a
                    ...
                    href={`/admin/payroll/export?start=${encodeURIComponent(isoDay(start))}&end=${encodeURIComponent(isoDay(end))}`}
                  >
                    Export CSV
                  </a>
                ) : (
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-4">
            ...
            <div className="mt-3 space-y-2">
              {periods.map((p) => {
                const href = `/admin/payroll?start=${encodeURIComponent(isoDay(p.start))}&end=${encodeURIComponent(isoDay(p.end))}`;
