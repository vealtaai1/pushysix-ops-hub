...
export function AdminLoginClient() {
  ...
  return (
    <main style={{ maxWidth: 720, margin: "32px auto", padding: 16 }}>
      ...
      <p style={{ marginTop: 8, color: "#444" }}>This admin area is protected by a temporary MVP gate.</p>
      <ul style={{ marginTop: 12, color: "#444" }}>
        <li>
          If <code>ADMIN_TOKEN</code> is configured, enter it below (or send it as <code> X-Admin-Token</code> /{" "}
      ...
      >
        ...
        {error ? <p style={{ color: "#b00020", marginTop: 4 }}>{error}</p> : null}
      ...
      <p style={{ color: "#666" }}>
        Note: this is not a full authentication system. It is meant only as an MVP safeguard until real auth is
        implemented.
      </p>
    </main>
  );
